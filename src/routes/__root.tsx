...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Beauty learning modules for Laura Mercier brand ambassadors.",
      },
      ...
      },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/095c97f1-91d9-4e9f-8748-a700b2020d61/id-preview-b3430ee1--64a70d3f-58dc-49d2-8d55-d9b5cecd662d.lovable.app-1782714229174.png",
      },
      {
        name: "twitter:image",
        content:
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Playfair+Display:wght@500;600;700;800;900&family=Montserrat:wght@300;400;500;600;700;800&display=swap",
      },
    ],
  }),
