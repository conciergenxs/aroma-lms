...
const T = {
  en: {
    ...
    errorDesc: "Something went wrong. Try refreshing or go back home.",
    tryAgain: "Try Again",
    // Login
    ...
    aboutThisCategory: "About This Category",
    aboutThisCategoryHint: "A category-wide module on the fundamentals, before the individual SKUs below.",
    aboutThisBrand: "About This Brand",
    ...
    noSearchResults: "No modules found for",
    noSearchResultsHint: "Try another keyword, or check the spelling.",
    searchEmptyPrompt: "Type a module name to search.",
  ...
  id: {
    ...
    pageNotFoundDesc: "Halaman yang kamu cari tidak ada atau telah dipindahkan.",
    errorTitle: "Halaman gagal dimuat",
    errorDesc: "Terjadi kesalahan. Coba refresh atau kembali ke beranda.",
    tryAgain: "Coba Lagi",
    // Login
    ...
    aboutThisCategory: "Tentang Kategori Ini",
    aboutThisCategoryHint: "Modul level kategori tentang dasar-dasarnya, sebelum SKU spesifik di bawah ini.",
    aboutThisBrand: "Tentang Brand Ini",
    ...
    noSearchResults: "Modul tidak ditemukan untuk",
    noSearchResultsHint: "Coba kata kunci lain, atau periksa ejaannya.",
    searchEmptyPrompt: "Ketik nama modul untuk mencari.",
